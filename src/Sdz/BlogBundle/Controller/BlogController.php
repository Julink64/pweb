...
// Suppression des catégories d'un article :
  ...
  public function menuAction($nombre) // Ici, nouvel argument $nombre, on l'a transmis via le render() depuis la vue
  {
    ...
    $doctrine = $this->getDoctrine()->getManager()->getRepository('SdzBlogBundle:Article');
  }
  ...
  public function modifierImageAction($id_article)
{
  ...
  {
    $em=$this->getDoctrine()->getManager();/*
    $liste_articles = $em->getRepository('SdzBlogBundle:Article')
                           ->findAll();
...
*/
    ...
    return $this->render('SdzBlogBundle:Blog:renitialisation.html.twig');
  }
