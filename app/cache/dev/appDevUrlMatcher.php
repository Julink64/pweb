...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            ...
            return array (  '_controller' => 'Pweb\\MainBundle\\Controller\\MainController::indexAction',  'page' => 1,  '_route' => 'PwebMain_accueil',);
        }
        ...
        // PwebMain_voir_slug
        if (preg_match('#^/(?P<annee>\\d{4})/(?P<slug>[^/\\.]++)(?:\\.(?P<format>html|xml))?$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'PwebMain_voir_slug')), array (  '_controller' => 'Pweb\\MainBundle\\Controller\\MainController::voirSlugAction',  'format' => 'html',));
        }
        ...
        // PwebMain_reinitialiser
        if ($pathinfo === '/reinitialiser') {
            return array (  '_controller' => 'Pweb\\MainBundle\\Controller\\MainController::reinitialiserAction',  '_route' => 'PwebMain_reinitialiser',);
        }
