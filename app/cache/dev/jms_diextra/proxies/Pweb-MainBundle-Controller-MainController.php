...
class MainController extends \Pweb\MainBundle\Controller\MainController
{
    ...
    {
        $ref = new \ReflectionMethod('Pweb\\MainBundle\\Controller\\MainController', 'commandevoirproduitsAction');
        $interceptors = $this->__CGInterception__loader->loadInterceptors($ref, $this, array($idcommande));
        $invocation = new \CG\Proxy\MethodInvocation($ref, $this, array($idcommande), $interceptors);
    ...
    {
        $ref = new \ReflectionMethod('Pweb\\MainBundle\\Controller\\MainController', 'commandetoutsupprimerAction');
        $interceptors = $this->__CGInterception__loader->loadInterceptors($ref, $this, array());
        $invocation = new \CG\Proxy\MethodInvocation($ref, $this, array(), $interceptors);
    ...
    {
        $ref = new \ReflectionMethod('Pweb\\MainBundle\\Controller\\MainController', 'commandesupprimerAction');
        $interceptors = $this->__CGInterception__loader->loadInterceptors($ref, $this, array($id));
        $invocation = new \CG\Proxy\MethodInvocation($ref, $this, array($id), $interceptors);
